...
public class SendContact extends SendableMessageRequest<ContactMessage> {
    ...
    @Builder
    private SendContact(Consumer<ContactMessage> callback, Consumer<TelegramException> errorHandler, ChatId chatId, Integer replyToMessageId, Boolean disableNotification, ReplyMarkup replyMarkup, String phoneNumber, String firstName, String lastName) {
