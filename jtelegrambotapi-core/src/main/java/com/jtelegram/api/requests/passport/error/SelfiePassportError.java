...
public class SelfiePassportError extends PassportElementError {
    ...
    @Builder
    public SelfiePassportError(EncryptedPassportElementType type, String message, String fileHash) {
        super("selfie", type, message);
