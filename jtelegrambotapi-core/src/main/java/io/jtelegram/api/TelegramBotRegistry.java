...
import io.jtelegram.api.message.requests.helpers.input.file.InputFileSerializer;
import io.jtelegram.api.message.requests.helpers.input.media.InputMediaType;
import io.jtelegram.api.message.sticker.MaskPoint;
import io.jtelegram.api.message.requests.types.sendable.GetMe;
